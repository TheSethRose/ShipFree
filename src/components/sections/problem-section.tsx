...
export function ProblemSection({ className = '' }: ProblemSectionProps) {
  return (
    <section id='problem' className={`border-b border-[#E4E4E7] bg-[#F4F4F5] py-24 ${className}`}>
        ...
        <div className='mt-16 grid gap-8 sm:grid-cols-3'>
          {problemData.painPoints.map((point, index) => {
            ...
            return (
              <div
                key={point.title}
                className='group relative rounded-xl border border-[#E4E4E7] bg-white p-6 transition-all duration-200 hover:border-muted-foreground/20 hover:shadow-sm'
              >
