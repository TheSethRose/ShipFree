...
export function HowItWorks({ className = '' }: HowItWorksProps) {
  return (
    <section id='how-it-works' className={`border-b border-[#E4E4E7] bg-[#F4F4F5] py-24 ${className}`}>
      <div className='mx-auto max-w-6xl px-4 sm:px-6'>
        <div className='mx-auto mb-16 max-w-2xl text-center'>
          ...
          <h2 className='text-4xl font-semibold tracking-tight'>{howItWorksData.title}</h2>
        </div>
