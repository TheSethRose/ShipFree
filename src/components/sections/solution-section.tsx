...
export function SolutionSection({ className = '' }: SolutionSectionProps) {
  return (
    <section id='solution' className={`border-b border-[#E4E4E7] bg-white py-24 ${className}`}>
        ...
        <div className='mt-16 grid gap-8 sm:grid-cols-3'>
          {solutionData.benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={benefit.title}
                className='group relative rounded-xl bg-[#F4F4F5] p-6 shadow-sm transition-all duration-200 hover:shadow-md'
              >
